...
def main():
    ...
    vsomeip.offer_event(SAMPLE_SERVICE_ID, SAMPLE_INSTANCE_ID, SAMPLE_EVENT_ID, SAMPLE_EVENTGROUP_ID)
    ...
    import time
    time.sleep(2)
    vsomeip.notify(SAMPLE_SERVICE_ID, SAMPLE_INSTANCE_ID, SAMPLE_EVENT_ID, bytearray([0x41,0x42,0x43,0x44,0x45,0x46,0x47,0x48]))
    time.sleep(15)
